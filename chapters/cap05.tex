...
\input{chapters/cap05/databaseImplementation}
\input{chapters/cap05/receiveDataModule}
\input{chapters/cap05/processDataModule}
\input{chapters/cap05/apiImplementation}

\input{chapters/cap05/frontend}

\input{chapters/cap05/otherContext}
