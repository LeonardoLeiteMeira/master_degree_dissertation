...
%\subsection[Implementação do modulo de recebimento de dados]{Implementação do modulo de recebimento de dados}
%A explicação deve passar pelas seguintes caracteristicas desse modulo:
%- A conexão é feita via multicast messages. Quando o sistema inicializa é chamada uma função que inicia a conexão, e roda uma função em loop infinito para receber todas as mensagens que forem transmitidas 
%- Ao receber uma mensagem... Terminar de detalhar 
