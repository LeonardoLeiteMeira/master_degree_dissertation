...
%TODO 31artigo Ref para o uso de result para comunicação entre camadas
...
%TODO 32referencia para boas praticas - justificando a aplicação gerir o ID e nao o próprio banco
